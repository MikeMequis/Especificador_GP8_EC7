...
public interface EasyLanguageListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link EasyLanguageParser#term}.
	 * @param ctx the parse tree
	 */
	void enterTerm(EasyLanguageParser.TermContext ctx);
	/**
	 * Exit a parse tree produced by {@link EasyLanguageParser#term}.
	 * @param ctx the parse tree
	 */
	void exitTerm(EasyLanguageParser.TermContext ctx);
	/**
	 * Enter a parse tree produced by {@link EasyLanguageParser#factor}.
	 * @param ctx the parse tree
	 */
	void enterFactor(EasyLanguageParser.FactorContext ctx);
	/**
	 * Exit a parse tree produced by {@link EasyLanguageParser#factor}.
	 * @param ctx the parse tree
	 */
	void exitFactor(EasyLanguageParser.FactorContext ctx);
	/**
	 * Enter a parse tree produced by {@link EasyLanguageParser#atom}.
	 * @param ctx the parse tree
	 */
	void enterAtom(EasyLanguageParser.AtomContext ctx);
	/**
	 * Exit a parse tree produced by {@link EasyLanguageParser#atom}.
	 * @param ctx the parse tree
	 */
	void exitAtom(EasyLanguageParser.AtomContext ctx);
}